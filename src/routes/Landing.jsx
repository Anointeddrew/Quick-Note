            ...
            <div className="container mx-auto px-4 py-16">
                <div className="text-center mb-16">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <Link className="inline-flex items-center justify-center px-6 py-3 bg-white text-indigo-600 font-medium rounded-lg hover:bg-indigo-50 transition-colors" to="/login">
                        Sign in
                        </Link>
                    </div>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                        <div>
                            <Zap className="h-6 w-6 text-indigo mr-3" />
                            <h3 className="text-lg font-semibold text-gray-900">Lightning Fast</h3>
                        </div>
                        <p className="text-grey-600">Create and access your notes instantly with our real-time sync technology</p>
                    </div>
                     <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                        <div>
                            <Lock className="h-6 w-6 text-indigo mr-3" />
                            <h3 className="text-lg font-semibold text-gray-900">Secure & Private</h3>
                        </div>
                        <p className="text-grey-600">Your notes are protected with enterprise-grade security and encryption.</p>
                    </div>
                     <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                        <div>
                            <CheckCircle className="h-6 w-6 text-indigo mr-3" />
                            <h3 className="text-lg font-semibold text-gray-900">Easy to Use</h3>
                        </div>
                        <p className="text-grey-600">Clean and intuitive interface that lets you focus on what matters most.</p>
                    </div>
                </div>
            </div>
        </div>
